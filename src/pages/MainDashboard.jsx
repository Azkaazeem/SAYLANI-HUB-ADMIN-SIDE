...
import { DonutStatCard, LiveUsersGraph } from '../Comp/DashboardComp/Widgets';
...
export default function MainDashboard() {
  ...
  useEffect(() => {
    const fetchRealData = async () => {
      ...
      const usersCount = await getCount('profiles'); // assuming your users table is 'profiles' or 'users'
